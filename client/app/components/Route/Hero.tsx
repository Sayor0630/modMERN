        ...
        <div className="absolute top-[100px] 1000px:top-[unset] 1500px:h-[700px] 1500px:w-[700px] 1100px:h-[600px] 1100px:w-[600px] h-[40vh] left-5 w-[40vh] hero_animation rounded-[50%] 1100px:left-8 1500px:left-14">
            ...
            <div className='1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]'>
                ...
                <div className='1500px:w-[55%] 1100px:w-[78%] w-[90%] flex items-center'>
                    <Image src={require("../../../public/assets/client-1.jpg")}
                    alt=""
                    className='rounded-full'
                    />
                    <Image src={require("../../../public/assets/client-2.jpg")}
                    alt=""
                    className='rounded-full ml-[-20px]'/>
                    <Image src={require("../../../public/assets/client-3.jpg")}
                    alt=""
                    className='rounded-full ml-[-20px]'
                    />
                    <p className='font-Josefin dark:text-[#edfff4] text-[#000000b3] 1000px:pl-3 text-[18px] font-[600]'>
                        500K+ People already trusted on us.{" "}
                        <Link
                            href="/courses"
